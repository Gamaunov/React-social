    ...
    <div className="post">
      <div className="postWrapper">
        <div className="postTop">
          <div className="postTopLeft">
            <img
              ...
              alt="person"
            />
            <span className="postUserName">Bulgakov Mikkie</span>
        ...
        <div className="postCenter">
          <span className="postText">Here`s my first post!</span>
          <img
            className="postImg"
            src="/assets/img/posts/post-1.jpg"
            alt="post"
          />
        </div>
        <div className="postBottom">
          <div className="postBotoomLeft">
